...
<template>
    <div>
        <div
            class="p-6 lg:p-8 bg-white dark:bg-realGray dark:bg-gradient-to-bl dark:from-green-950 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
        ...
        <div
            class="bg-gray-200 dark:bg-realGray bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                ...
                <p class="mt-4 text-sm">
                    <a href="https://laravel.com/docs"
                        class="inline-flex items-center font-semibold text-primaryColor dark:text-primaryColor">
                        Explore the documentation

                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            class="ms-1 size-5 fill-primaryColor dark:fill-primaryColor">
