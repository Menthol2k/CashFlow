...
const form = useForm({
    ...
    denumire: props.client.denumire,
    regcom: props.client.regcom,
    cod_client: props.client.cod_client,
    platitor_tva: props.client.platitor_tva,
    adresa: props.client.adresa,
    tara: props.client.tara,
    judet: props.client.judet,
    localitate: props.client.localitate,
    iban: props.client.iban,
    banca: props.client.banca,
    email: props.client.email,
    persoana_de_contact: props.client.persoana_de_contact,
    telefon: props.client.telefon,
});
    ...
    <AppLayout title="Adaugare client">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Modificare client <span class="text-primaryColor font-extrabold">{{ props.client.denumire }}</span>
            </h2>
        </template>
