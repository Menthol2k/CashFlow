    ...
    <FormSection @submitted="createTeam">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <TextInput id="cif" v-model="form.cif" type="text" class="block w-full mt-1" />
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <TextInput id="cont_bancar" v-model="form.cont_bancar" type="text" class="block w-full mt-1" />
